...
export const CHECKPOINTS = ['monday', 'thursday', 'matchDay', 'postMatch', 'seasonEnd'] as const
...
export const STAFF_EFFECTS: Record<StaffRole, string> = {
  ...
  defenceCoach: 'Improves tackling technique, defensive line speed, and discipline.',
  scCoach: 'Accelerates power & speed progression; improves stamina resistance.',
  physio: 'Speeds up injury rehabilitation and reduces match/training injury risk.',
  chiefScout: 'Improves scouting accuracy and reveals hidden player potentials.',
  academyDirector: 'Scouts higher-potential youth candidates and mentors teenage prospects.',
}
...
export const FACILITY_EFFECTS = {
  ...
  academy: 'Improves annual youth intake quality and accelerates youth progression.',
} as const
...
export type AttackStructurePreset = 'standard' | 'pod_1_3_3_1' | 'pod_2_4_2' | 'wide_spread'

export type DefenseStructurePreset = 'drift' | 'blitz' | 'pendulum_cover' | 'aggressive_rush'

export type SetPieceFocusPreset = 'balanced' | 'quick_tap' | 'maul_drive' | 'territory_boot'
...
export const COACHING_COURSES: Record<CoachingCourseId, CoachingCourseInfo> = {
  wr_foundation: {
    ...
    cost: 5_000,
    roundsDuration: 2,
    description: 'Fundamental coaching principles, training drills, and foundational player development.',
  ...
  attack_architecture: {
    ...
    cost: 15_000,
    roundsDuration: 3,
    description: 'Advanced phase play structures, 1-3-3-1 and 2-4-2 forward pods to manipulate defensive edges.',
    perks: ['Unlocks 1-3-3-1 Forward Pod Structure', 'Unlocks 2-4-2 Wide Pod Structure', 'Unlocks High-Tempo Play'],
    unlocks: {
  ...
  defense_mastermind: {
    ...
    cost: 20_000,
    roundsDuration: 3,
    description: 'High-pressure blitz rush defense, drift containment, and backfield pendulum coverage.',
    perks: ['Unlocks Blitz Press Defense', 'Unlocks Pendulum Backfield Cover', 'Unlocks Aggressive Rush Defense'],
    unlocks: {
  ...
  setpiece_mastery: {
    ...
    cost: 30_000,
    roundsDuration: 4,
    description: 'Technical scrummaging, deceptive lineout movements, rolling maul dominance, and breakdown poaching.',
    perks: ['Unlocks Maul Drive Focus', 'Unlocks Territory Boot Strategy', 'Unlocks Quick Tap Strategy'],
    unlocks: {
