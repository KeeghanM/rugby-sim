...
export const OPEN_ATTACK_FORMATIONS: Record<OpenAttackFormation, readonly Slot[]> = {
...
export const KICKOFF_ATTACK_FORMATIONS: Record<KickoffAttackFormation, readonly Position[]> = {
...
export const KICKOFF_DEFENCE_FORMATIONS: Record<KickoffDefenceFormation, readonly Position[]> = {
...
export const LINEOUT_MEMBER_VARIANTS: Record<LineoutMembers, readonly number[]> = {
  4: [1, 3, 4, 5],
  5: [1, 3, 4, 5, 8],
  6: [1, 3, 4, 5, 6, 8],
  7: [1, 3, 4, 5, 6, 7, 8],
...
export const OPEN_DEFENCE_VARIANTS: Record<OpenDefenceFormation, { width: number; fullbackDepth: number }> = {
  connected: { width: 1, fullbackDepth: 24 },
  narrow: { width: 0.82, fullbackDepth: 22 },
  wide: { width: 1.08, fullbackDepth: 27 },
}

export const DEFENCE_X = [-18, -12, -6, 0, 6, 12, 18, -24, 24, -9, -30, -3, 3, 30]
