import { attackDirection, PITCH, ROLES, type Player, type Position, type Team } from '../domain.ts'
import { ATTACK_FORMATION } from './constants.ts'
import { KICKOFF_ATTACK_FORMATIONS, KICKOFF_DEFENCE_FORMATIONS } from './constants.ts'
import type { KickoffAttackFormation, KickoffDefenceFormation } from './types.ts'
